...
<div class='chatcontrols'>
	...
	<input type='text' name='chat' id='chatbox' autocomplete="off" required placeholder="ENTER CHAT HERE" oninput = "getResultsFromNlp()"/>
...
function getResultsFromNlp(){
	var x = document.getElementById("chatbox").value;
	
	if(x!=null){var sentimood = new Sentimood();
	var analysis = sentimood.analyze(x);
	document.getElementById('clear').value = (analysis['score']);}
}
function submitchat(){
